          ...
          <form className=" z-50 space-y-4" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" id="first_name" name="firstName" value={formData.firstName} onChange={handleChange} className="p-3 rounded-lg bg-white bg-opacity-20 border border-gray-300 text-white"   />
             ...
             <div>
                ...
                <input type="number" id="mobile" name="mobile" value={formData.mobile} onChange={handleChange} className="p-3 rounded-lg bg-white bg-opacity-20 border border-gray-300 text-white"   />
            ...
            <div className=" gap-4">
              ...
              <div>
                ...
                <input type="text" id="email" name="email" value={formData.email} onChange={handleChange} className="p-3 rounded-lg bg-white bg-opacity-20 border border-gray-300 text-white"   />

...
>
    ...
    <div className="bg-purple-50 min-h-screen flex  p-5  sm:p-16 flex-col md:flex-row">
      
      {/* Overview Section */}
      <section className="w-full items-center md:w-1/2 p-8">
      ...
      <div className="w-full md:w-1/2 p-8">
        <h1 className="text-4xl text-headingColor text-center font-semibold mb-8">Doctors</h1>

...
import BookingOtpComponent from './BookingOtpComponent';
import './Login.css';

function BookingOtp() {
  const [otp, setOtp] = useState(Array(4).fill("")); 
  const { showBookingOTP, setShowBookingOTP } = useContext(BookingContext);

  // console.log('consoling from Modal ',showBookingOTP)
  ...
  return (
    ...
    showBookingOTP && (
            ...
            className="modal-overlay flex flex-row justify-center s:flex-row sm:justify-end ">
                 ...
                 <div onClick={()=>setShowBookingOTP(false)} className="flex  justify-end">
                 ...
                 <div className="mt-6 flex items-center justify-center">
                         ...
                         <BookingOtpComponent otp={otp} setOtp={setOtp}/>

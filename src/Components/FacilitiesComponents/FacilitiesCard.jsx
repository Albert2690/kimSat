...
function FacilitiesCard({ heading, icon, paragraph_1 }) {
  return (
    <div className="bg-white relative p-6 space-y-9 rounded-lg shadow-md">
            <div className="text-center mb-4">
                <i className={`${icon} text-4xl text-secondaryColor`}></i>
            </div>
            <h3 className="text-xl text-headingColor font-semibold text-center mb-2">{heading}</h3>
            <p className="para text-justify mb-4">{paragraph_1}</p>

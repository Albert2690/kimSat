...
// };
  ...
  return (
    <>
      ...
      <div className=' hidden sm:flex flex-col gap-5 z-20 fixed bottom-40 right-4'>
      ...
      {isVisible && (
        ...
        >
          <FontAwesomeIcon
            icon={faArrowUp}
            className="p-1 text-white text-lg rounded-full transform transition-transform duration-1000 group-hover:translate-y--2"
          />
        </motion.button>
      )}
      ...
      {isAtTop && (
        <motion.button
          ...
          className=" bg-thirdColor text-lg hover:bg-secondaryColor text-white p-2 rounded-full flex space-x-2 items-center group transition-all duration-300 ease-in-out shadow-lg"
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.9 }}
        >
          <FontAwesomeIcon
